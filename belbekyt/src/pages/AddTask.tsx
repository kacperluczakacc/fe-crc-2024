        ...
        <section>
            ...
            <form className="flex flex-col gap-10 my-6 px-5">
                ...
                <div className="flex flex-col relative">
                    ...
                    <input className="border h-14 p-4" type="text" onInput={(input) => setAuthor(input.currentTarget.value)} />
                ...
                <div className="flex gap-4 ">
                    ...
                    <button type="button" onClick={() => handleCustomButtonClick(CustomDate.TOMMOROW)} className={`border rounded-lg px-4 py-1 border-slate-300 hover:bg-primary hover:text-white ${customButtonDate === CustomDate.TOMMOROW ? 'bg-primary text-white' : ''}`}>Tommorow</button>
                </div>

                <p>Or select your date</p>

                <div>
                    <DatePicker className="w-full" value={customButtonDate !== null ? null : deadline}
                    onChange={(date) => {
                        setDeadline(date);
                        setDeadlineError(false);
                    }}
